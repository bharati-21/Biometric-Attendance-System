...
namespace CorporateCoders.Database1DataSet3TableAdapters {
    ...
    public partial class AttendanceTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Attendance] ([Id], [Name], [DayOfMonth], [Month], [Year], [Ver" +
                "Time], [Status]) VALUES (@Id, @Name, @DayOfMonth, @Month, @Year, @VerTime, @Stat" +
                "us)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, DayOfMonth, Month, Year, VerTime, Status FROM dbo.Attendance";
